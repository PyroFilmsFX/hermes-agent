...
_LONG_HANDLERS = frozenset({
    ...
    "relay_jobs.list", "conductor_build.get",  # workspace marker + relay job file reads
    ...
    "session.resume", "session.send", "session.workspace.move", "shell.exec", "skills.manage", "slash.exec",
    ...
    if obj.get("method") == "event" or (isinstance(obj.get("id"), str) and "method" in obj):
        ...
        if sid and (t := (_sessions.get(sid) or {}).get("transport")) is not None:
            if t is _detached_ws_transport:
                ...
                # ``session.events.since``. (cntrl carry)
...
from . import (  # noqa: E402
    ...
    methods_relay_jobs as _methods_relay_jobs, methods_conductor_build as _methods_conductor_build,
...
for _m in (
    ...
    _methods_session_control, _methods_subagents, _methods_relay_jobs, _methods_conductor_build, _methods_vault, _methods_free_tier, _methods_connectors,
