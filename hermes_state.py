...
from hermes_state_peer_mailbox import SessionPeerMailboxMixin  # cntrl carry: durable cross-session mailbox
...
class SessionDB(
    ...
    SessionMessagesMixin, SessionRewindMixin, SessionPeerMailboxMixin, SessionProfileRepairMixin,
):
