...
import { isQuietApiFailure, withQuietApiFailures } from './api-error-envelope'
import {
...
ipcMain.handle('hermes:api', async (_event, request) =>
  ...
  try {
    ...
    // Expected failures (polled-session 404s) stay quiet here too: they travel
    // as envelopes (withQuietApiFailures) and must not bury real errors.
